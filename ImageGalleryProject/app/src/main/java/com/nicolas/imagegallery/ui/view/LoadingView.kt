...
class LoadingView : FrameLayout {
    ...
    var mainContentGroup: Group? = null
    ...
    fun attach(
        ...
        mainContentGroup: Group? = null,
        onRetryAction: () -> Unit
    ) {

        this.mainContentView = mainContentView
        this.mainContentGroup = mainContentGroup
...
//                }
    ...
    fun showLabel(@StringRes stringResId: Int, paddingBottom: Int = 0) {
        visibility = View.VISIBLE
        textView.setText(stringResId)
